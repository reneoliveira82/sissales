...
<!-- BEGIN CORE PLUGINS -->
<!--<script src="{{asset('metronic/assets/global/plugins/jquery.min.js')}}" type="text/javascript"></script> Foi colocado no topo -->
<!--<script src="{{asset('metronic/sweet-modal/docs/js/jquery.min.js')}}" type="text/javascript"></script>-->
<!--<script src="{{asset('metronic/sweet-modal/docs/js/jquery.sweet-modal.min.js')}}" type="text/javascript"></script>-->
...
<script src="{{asset('metronic/assets/global/plugins/jquery-minicolors/jquery.minicolors.min.js')}}" type="text/javascript"></script>
<script src="{{asset('metronic/assets/global/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js')}}" type="text/javascript"></script>
...
<script src="{{asset('metronic/assets/global/plugins/jquery-validation/js/validator.min.js')}}" type="text/javascript"></script>
...
<script src="{{asset('metronic/assets/pages/scripts/components-multi-select.min.js')}}" type="text/javascript"></script>
...
<!--<script src="{{asset('metronic/assets/pages/scripts/ui-modals.min.js')}}" type="text/javascript"></script>-->
<script src="{{asset('metronic/assets/global/plugins/jquery-inputmask/jquery.mask.min.js')}}" type="text/javascript"></script>
<!--<script src="{{asset('metronic/assets/pages/scripts/table-datatables-responsive.js')}}" type="text/javascript"></script>-->

<script src="{{asset('metronic/assets/global/plugins/bootstrap-confirmation/bootstrap-confirmation.js')}}" type="text/javascript"></script>
<script src="{{asset('metronic/assets/global/scripts/app.min.js')}}" type="text/javascript"></script>

<!--<script src="{{asset('metronic/assets/pages/scripts/ui-confirmations.min.js')}}" type="text/javascript"></script>-->
<!-- END THEME GLOBAL SCRIPTS -->

<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="{{asset('metronic/assets/pages/scripts/components-bootstrap-maxlength.min.js')}}" type="text/javascript"></script>
<script src="{{asset('metronic/assets/global/plugins/bootstrap-datepicker/locales/bootstrap-datepicker.pt-BR.min.js')}}" type="text/javascript"></script>
<script src="{{asset('metronic/assets/pages/scripts/components-color-pickers.min.js')}}" type="text/javascript"></script>
<script src="{{asset('metronic/assets/pages/scripts/components-date-time-pickers.min.js')}}" type="text/javascript"></script>
<script src="{{asset('metronic/assets/extras/jquery.mask.js')}}" type="text/javascript"></script>
...
<!--<script src="{{asset('metronic/modelo/jquery-ui.custom.min.js')}}"></script>-->
<script src="{{asset('metronic/modelo/mapa.js')}}" type="text/javascript"></script>
