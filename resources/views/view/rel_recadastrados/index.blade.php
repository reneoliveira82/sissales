...
@section('titulo','Relatório de Recadastrados | Sistema Gestão de Recadastramento')
@section('conteudo')
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green bold uppercase">Relatório de Recadastrados</span>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $.ajax({
            url: "{{ route('rel_recadastrados.tabela') }}",
            type: 'GET',
            data: {},
            beforeSend: function() {
    ...
    $('#pesquisar').click(function() {        
        ...
        if (data_inicial =="" && data_final ==""){   
            $('.date_validator').html("<div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>  <strong>Error: </strong> Informe um periodo! </div>");                 
                ...
                url: "{{ route('pesquisar.rel_recadastrados.tabela') }}",
                type: 'GET',
                data: {
