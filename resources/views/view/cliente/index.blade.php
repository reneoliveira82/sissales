...
@section('titulo','Cadastro de Clientes | Sistema de Vendas')
@section('conteudo')
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green bold uppercase">Lista de Clientes Cadastrados </span>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $('#novo').click(function() {
        var pagina = "{{ route('cad_cliente.cad') }}";
        $(location).attr('href', pagina);
    });
    function editar(o) {
       
        var pagina = "{{ route('cad_cliente.cad', '_codigo_') }}".replace('_codigo_', o);
        $(location).attr('href', pagina);
    }
    function excluir(o) {
        var codigo = o.data('id');
        if (codigo != '') {
            var pagina = "{{ route('cad_cliente.delete', '_codigo_') }}".replace('_codigo_', codigo);
            $(location).attr('href', pagina);
        }
    }
