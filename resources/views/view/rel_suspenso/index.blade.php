...
@section('titulo','Relatório de Suspensos | Sistema Gestão de Recadastramento')
@section('conteudo')
                ...
                <div class="portlet light bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-green bold uppercase">Suspenso por não recadastramento</span>
                        </div>
                    </div>
    ...
    $('#pesquisar').click(function() {        
        ...
        if (data_inicial =="" && data_final ==""){   
            $('.date_validator').html("<div class='alert alert-danger'><button type='button' class='close' data-dismiss='alert' aria-hidden='true'></button>  <strong>Error: </strong> Informe um periodo! </div>");                 
                ...
                url: "{{ route('pesquisar.rel_suspenso.tabela') }}",
                type: 'GET',
                data: {
